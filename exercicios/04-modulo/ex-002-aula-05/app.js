...
const newColor = (color) => (cat["color"] += ` e ${color}`);
...
let dog = {
  ...
  age: 4,
  color: "Branco",
  bestFriends: ["Puro Osso", "Latreu", "Robson"],
  sound: () => "Au! Au!",
};

const sumMessage = (dogObject, catObject) =>
  `A soma das idades de ${catObject.name} e ${dogObject.name} é ${
    dogObject.age + catObject.age
  }`;
console.log(sumMessage(dog, cat));
...
console.log(valueType("undefined"));
