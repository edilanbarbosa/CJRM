...
const fruits = ["morango", "banana", "mamão", "goiaba"];

if (fruits.includes("pera") && fruits.includes("abacaxi")) {
  console.log(
    'Tanto a string "pera" quanto a string "abacaxi" existem no array "fruits".'
  );
} else if (fruits.includes("pera")) {
  console.log('A string "pera" existe no array fruits.');
} else if (fruits.includes("abacaxi")) {
...
console.log(
  `O crazyArray tem ${booleanCounter} booleans, ${numberCounter} números e ${stringCounter} strings.`
);
...
const oddString = oddNumbers.join(", ").replace(", 3", " e 3");
const evenString = evenNumbers.join(", ").replace(", 5", " e 5");

console.log(`Numeros ímpares: ${oddString}. Números pares: ${evenString}.`);
