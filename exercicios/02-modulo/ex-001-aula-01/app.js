...
const my3FavoriteTVShows = ["Doctor Hu", "Sobrenatural", "Naruto"];
...
// console.log(
//   `A string que a "typeSentence" armazena tem mais de ${itemsNum} caracteres? ${String(
//     typeSentence.length > itemsNum
//   ).replace("t", "T")}.`
// );
...
/*
  ...
  - Você sabe por que essa conversão resultou em true?
    - Pq resultou em um valor truthy
*/
