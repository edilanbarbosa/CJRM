...
const endWord = randomWord.slice(-1);
// const endWord = randomWord.slice(randomWord.length - 1)
// const endWord = randomWord[randomWord.length - 1]
...
newName = `${name[0].toUpperCase() + name.slice(1, 6)} ${
